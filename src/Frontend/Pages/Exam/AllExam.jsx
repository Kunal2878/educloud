        ...
        <div className="flex flex-col md:flex-row gap-[16px] md:gap-[16px]">
          <div className="flex-1">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-10">
              <div className="relative mb-10">
                ...
                {errors.examName && <span className="text-red-500 text-sm">Exam Name is required</span>}
              </div>
              ...
              <div className="relative mb-10">
                ...
                {errors.examDate && <span className="text-red-500 text-sm">Exam Date is required</span>}
              </div>
          ...
          <div className="md:w-1/3 flex flex-col justify-center  pl-0 md:pl-8">
            <div className="flex flex-col items-center justify-center h-full">
              ...
              {errors.timeTable && <span className="text-red-500 text-sm">{errors.timeTable.message}</span>}
            </div>
          </div>
        </div>
      </div>
