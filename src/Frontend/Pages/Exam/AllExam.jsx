        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-lamaYellowLight">
              <tr>
                <th scope="col" className="px-6 py-3 text-left subtitle-1">
                  Index
                </th>
                <th scope="col" className="px-6 py-3 text-left subtitle-1">
                  Exam Name
              ...
              {isLoadingExams ? (
                ...
                exams.map((exam, index) => (
                  <tr key={exam._id} className="text-left hover:bg-gray-50">
                    <td className="px-6 py-4 subtitle-2">{index + 1}</td>
                    <td className="px-6 py-4 subtitle-2">{exam.name}</td>
