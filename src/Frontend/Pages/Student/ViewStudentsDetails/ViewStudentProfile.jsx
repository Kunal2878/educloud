    ...
    <div className="min-h-screen  sm:px-16 px-6 sm:py-16 py-10">
      <div className="max-w-4xl mx-auto main">
        ...
        <div className="flex flex-col md:flex-row  overflow-hidden mb-6 gap-4 p-2">
          ...
          <div className="w-full md:w-1/2 p-6 flex md:flex-col flex-col gap-6 bg-blue-100 rounded-lg h-60 ">
            ...
            <div className=" flex flex-col justify-center w-full ">
              <div className="w-full flex flex-col gap-2 md:gap-4">
                ...
                <div className="flex items-center gap-2 w-full">
                  ...
                  <div>
                    <span className="text-sm md:text-md font-medium text-black-300">{user?.parentContact || "987645335"  }</span>
                  </div>
                </div> 
                <div className="flex items-center gap-2 w-full">
                  <User className="size-3 md:size-6 font-black text-black-300" />
                  <div>
                    <span className="text-sm md:text-md font-medium text-black-300">{user?.parentName || "Parent" }</span>
                  </div>
                </div> 
            ...
            <div className="w-full md:w-1/2 flex flex-wrap gap-4 mb-6">
                ...
                <div className="bg-lamaYellowLight p-3 rounded-lg shadow-md flex items-center gap-3 w-[calc(50%-8px)] h-20">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <h3 className="text-md md:text-lg font-black text-black">{user.studentClass?.className || "ClassName"}</h3>
          ...
          <div className="md:col-span-2">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-left text-sm text-black-300 mb-6">
                criteria: Feedback from Teacher
              </p>
