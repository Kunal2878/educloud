  ...
  useEffect(()=>{
    ...
    if (loading) {
      return (
        <div className="sm:px-16 px-6 sm:py-16 py-10 min-h-[80vh] min-w-[50vh]">
          <div className="bg-white p-2 rounded-md shadow-lg flex items-center justify-center h-96">
      ...
      <div className="sm:px-16 px-6 sm:py-16 py-10 min-h-screen">
        ...
        <div className="flex flex-col md:flex-row text-black justify-between items-start md:items-center mb-[32px] p-2">
          <div className="mb-4 md:mb-0">
            <h2 className="h2 mb-2">Fee History</h2>
          </div>
