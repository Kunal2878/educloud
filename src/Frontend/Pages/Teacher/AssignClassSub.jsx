...
import { GetAllClass, GetAllTeacher, AssignClassSubject } from '../../Route';
import { GetSubjectByClassAPI } from '../../../service/api';

const AssignClassSub = () => {
  const [activeTab, setActiveTab] = useState('assign'); // New state for tabs
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (activeTab === 'assign') {
        ...
        setShowToast({
          show: true,
          message: "Successfully assigned class and subjects",
          type: "right",
        });
      } else {
        // Delete request
