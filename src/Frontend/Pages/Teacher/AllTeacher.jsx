  ...
  return (
    <div className="p-6 bg-white min-h-screen mt-12">
      ...
      <div className="flex flex-col md:flex-row text-gray-600 justify-between items-start md:items-center mb-6 bg-purple-50 p-2">
        ...
        <Link to="/add-teachers" className="px-4 py-2 border-2 border-purple-500 text-sm text-purple-500 rounded-lg  transition-colors duration-200 transform hover:scale-105">
          + Add Teacher
        </Link>
      </div>
