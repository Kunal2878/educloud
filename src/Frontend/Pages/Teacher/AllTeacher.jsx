    ...
    const fetchTeachers = async () => {
      try {
        ...
        const response = await fetch(
          "https://school-backend-ocze.onrender.com/api/v1/teacher/all-teachers"
        );
    ...
    <div className="pl-6 pr-6 pb-6 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row text-black-300 justify-between items-start md:items-center mb-6 p-2">
        <div className="mb-4 md:mb-0">
          <h1 className="text-2xl font-medium mb-2">All Teachers </h1>
        ...
        <button
          ...
          className="flex items-center p-2 border-2  border-primaryBlue text-lg text-primaryBlue rounded-lg  transition-colors duration-200 transform hover:scale-105"
        >
          <span>
            <Plus size={20} />
          </span>{" "}
        ...
        >
          <div className="relative rounded-lg w-auto max-w-4xl p-4">
            <button
              ...
              className="absolute top-6 lg:top-4 right-2 p-2 bg-white rounded-full text-black-300 hover:text-gray-800 transition-colors duration-200 transform hover:scale-110 shadow-md"
            >
              <X size={24} />
            </button>
              ...
              {currentTeachers.map((teacher) => (
                ...
                >
                  ...
                  {/* <td className="p-4 text-left">
                    {teacher.subject.length ? teacher.subject.join(", ") : "-"}
                  </td>
                  <td className="p-4 text-left">
