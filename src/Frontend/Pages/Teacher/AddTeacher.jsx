...
console.log(token)
  const onSubmit = async (data) => {
    setLoading(true);
    try {
      const response = await fetch(`${url}/api/v1/teacher/register`, {
        method: "POST",
        headers: {
      ...
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-xl shadow-lg hover:scale-[1.02] hover:shadow-2xl">
        <div className="text-center">
          <h2 className="text-3xl font-bold text-black mb-2">
            Add Teachers to <span className="text-purpleColor">Edu</span>cloud 🚀
          </h2>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          <div className="relative mb-6">
            ...
            >
              <span className="text-danger">* </span>Teacher Name
            </label>
            {errors.name && (
          ...
          <div className="relative mb-6">
            ...
            >
              <span className="text-danger">* </span>Teacher Email Address
            </label>
            {errors.email && (
