                    ...
                    <div className="absolute -left-24 -top-10 w-20">
                      <div className="flex flex-col items-start">
                        <div className="flex items-center mb-1">
                          ...
                          <span className="text-sm font-medium" style={{ color: FEMALE_COLOR }}>Female</span>
                        </div>
                        <span className="text-sm font-bold" style={{ color: FEMALE_COLOR }}>
                          {GenderRatio?.femaleCount} ({((GenderRatio?.femaleCount / (GenderRatio?.maleCount + GenderRatio?.femaleCount)) * 100).toFixed(1)}%)
                        </span>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="absolute -right-24 -top-10 w-20">
                      <div className="flex flex-col items-end">
                        <div className="flex items-center mb-1">
                          ...
                          <span className="text-sm font-medium" style={{ color: MALE_COLOR }}>Male</span>
                        </div>
                        <span className="text-sm font-bold" style={{ color: MALE_COLOR }}>
                          {GenderRatio?.maleCount} ({((GenderRatio?.maleCount / (GenderRatio?.maleCount + GenderRatio?.femaleCount)) * 100).toFixed(1)}%)
                        </span>
                      </div>
                    </div>
                  </div>
