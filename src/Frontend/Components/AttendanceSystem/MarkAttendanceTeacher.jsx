...
import{GetAllTeacher,GetTeacherAttendance,MarkTeacherAttendance} from '../../Route'
...
const TeacherAttendanceSystem = () => {
  ...
  const fetchTeachers = async () => {
    setLoading(true);
    try {
      const response = await axios.get(`${url}${GetAllTeacher}`); // Adjust the endpoint as needed
